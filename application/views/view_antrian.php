...
<html>
<head>
	<title>Antrian Interview PT. Siprama Cakrawala</title>
	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card-deck shadow-lg p-3 mb-5 bg-white rounded" id="print-antri">
			  <div class="card">
			      <div class="card-header text-center" style="font-size: 70px; font-weight: bold">PT. SIPRAMA CAKRAWALA</div>
			...
			<br>
			<button type="button" onclick="print_antrian()" class="btn btn-lg btn-primary" style="width:100%;"><b><br><br><h1>DOWNLOAD NOMOR ANTRIAN</h1><br><br></b></button>	
		</div>
		<div class="col-md-2">
		</div>
	</div>
